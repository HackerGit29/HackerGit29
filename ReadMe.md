...
Étudiant en 4ᵉ année d’ingénierie informatique, passionné par le développement d’applications web et mobiles. J’aime concevoir des solutions qui facilitent la transformation digitale des entreprises, en combinant code propre, sens de l’UX et curiosité technique. Mon objectif est de créer des produits utiles, efficaces et durables, orientés impact plutôt que complexité.

Actuellement, j’explore le DevOps Azure, Terraform, AWS, la sécurité Azure, l’IA et l’Infrastructure as Code pour construire des applications résilientes et robustes. Ouvert aux collaborations sur des projets tech innovants (web, mobile, IA, outils de productivité, automatisation, etc.).

## Compétences clés

- **Cloud & DevOps** : Azure (Azure Container Apps, Azure AI, Azure Security), AWS, DevOps, CI/CD via GitHub Actions, pipelines DevOps.
- **Développement** : Web full‑stack (React, TypeScript, HTML/CSS/JS), mobile Flutter, WordPress & Elementor, automatisation et intégration d’API.
- **IA & outils** : IA générative, Azure AI Studio, prompt engineering, augmentation de productivité avec l’IA, analyses et workflows IA/Figma.
- **UX/UI & contenu** : Conception UX/UI (Figma), SEO, réseaux sociaux, création de contenus digitaux et design Canva.
